...

  {
    ...
    children: [

      {
        ...
        name: 'ExamOnline',
        meta: { title: '在线作答', noCache: true, icon: 'guide' }
      },

      {
        ...
        name: 'PreExam',
        meta: { title: '准备作答', noCache: true, activeMenu: '/my/exam' },
        hidden: true
      },

      {
        ...
        name: 'ShowExam',
        meta: { title: '作业详情', noCache: true, activeMenu: '/online/exam' },
        hidden: true
      },
...

      {
        ...
        name: 'BookList',
        meta: { title: '错题', noCache: true, activeMenu: '/my/exam/records' },
        hidden: true
      },
...

  {
    ...
    children: [
...

      {
        ...
        name: 'ListExam',
        meta: { title: '作业管理', noCache: true, icon: 'log' }
      },

      {
        ...
        name: 'AddExam',
        meta: { title: '添加作业', noCache: true, activeMenu: '/exam/exam' },
        hidden: true
      },

      {
        ...
        component: () => import('@/views/exam/exam/form'),
        name: 'UpdateExam',
        meta: { title: '修改作业', noCache: true, activeMenu: '/exam/exam' },
        hidden: true
      },
      {
        ...
        name: 'ListExamUser',
        meta: { title: '作答人员', noCache: true, activeMenu: '/exam/exam' },
        hidden: true
      },
      {
        ...
        name: 'ListPaper',
        meta: { title: '作答记录', noCache: true, activeMenu: '/exam/exam' },
        hidden: true
      }
    ]
  },
