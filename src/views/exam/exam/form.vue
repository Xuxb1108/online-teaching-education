<template>
  <div class="app-container">
    ...
    <el-card style="margin-top: 20px">
      ...
      <div style="float: right; font-weight: bold; color: #ff0000">作业总分：{{ postForm.totalScore }}分</div>
    ...
    <el-card style="margin-top: 20px">
      ...
      <el-form ref="postForm" :model="postForm" :rules="rules" label-position="left" label-width="120px">
        ...
        <el-form-item label="练习时长(分钟)" prop="totalTime">
        ...
        <el-form-item v-if="postForm.timeLimit" label="作答时间" prop="totalTime">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        title: [
          { required: true, message: '作业名称不能为空！' }
        ],
        ...
        totalScore: [
          { required: true, message: '作业分数不能为空！' }
        ],
        ...
        totalTime: [
          { required: true, message: '作业时间不能为空！' }
        ],

        ruleId: [
          { required: true, message: '作业规则不能为空' }
        ],
        password: [
          { required: true, message: '作业口令不能为空！' }
        ]
      }
    }
  },
