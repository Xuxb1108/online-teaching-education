      ...
      <el-col :span="16">
        <el-card class="box">
          ...
          <div style="line-height: 32px;">
            ...
            线上课业辅导系统是一款基于SpringBoot+Vue开发的试题练习系统。包含在线练习、用户体系、错题训练、规则、智能算分等功能，流程通畅。
            ...
            <div>
              ...
              <div>试题权限：支持指定试题范围：完全公开、指定人员练习</div>
              <div>在线练习：学员在线练习、查看分数、错题训练。</div>
            </div>
          ...
          <div>
            ...
            <div style="display: flex;">
              <div style="flex-grow: 1;">
                ...
                <div>手机：<a href="tel:18603038204">18603038204（徐女士）</a></div>
