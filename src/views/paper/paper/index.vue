<template>
  ...
  <div>
    ...
    >
      ...
      <template #data-columns>
        ...
        >
          ...
          <template v-slot="scope">
            <span v-if="scope.row.state===1">待批阅</span>
            <span v-else-if="scope.row.state===0">待提交</span>
            <span v-else>
        ...
        >
          ...
          <template v-slot="scope">
            <el-button type="primary" size="small" @click="handleCapture(scope.row.id)">作答截图</el-button>
          </template>
    ...
    <el-dialog :visible.sync="dialogVisible" title="作答截图" width="500px">
