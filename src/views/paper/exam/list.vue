<template>
  ...
  <div>
    ...
    <!-- <div v-if="breakShow" style=" cursor: pointer; padding: 20px 20px 0px 20px" @click="toExam">
      <el-alert
        :closable="false"
        title="您有正在写作业，离线太久作业成绩将会作废哦，点击此处可继续写作业！"
        type="error"
      />
    </div> -->
    ...
    >
      ...
      <template #data-columns>
        ...
        >
          <template v-slot="scope">
            <el-button v-if="scope.row.state===0" icon="el-icon-caret-right" type="primary" size="mini" @click="handlePre(scope.row.id)">去答题</el-button>
