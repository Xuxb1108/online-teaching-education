  ...
  <div>
    ...
    >
      ...
      <template #data-columns>
        ...
        >
          <template v-slot="scope">
            <el-button type="primary" size="mini" icon="el-icon-view" @click="handleExamDetail(scope.row.examId, scope.row.userId)">作业明细</el-button>
          </template>
    ...
    <el-dialog :visible.sync="dialogVisible" title="作业明细" width="60%">
